...
/* package stackTest-0.1.0.0 */
#define VERSION_stackTest "0.1.0.0"
#define MIN_VERSION_stackTest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "stackTest-0.1.0.0-GYeYAx4ApZVF3rsQY1OaRV"

#define CURRENT_PACKAGE_KEY "stackTest-0.1.0.0-GYeYAx4ApZVF3rsQY1OaRV"
